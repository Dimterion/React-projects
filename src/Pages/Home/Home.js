  ...
  return (
    <section>
      <div className="home-header">
        ...
        <h3>The app was built with React and React Router.</h3>
        <p>
      ...
      <div className="home-links">
        ...
        <Link to="/travel-journal"><img src={travelJournalImg} alt="Travel Journal section cover"/></Link>
        <Link to="/meme-generator"><img src={memeGeneratorImg} alt="Meme Generator section cover"/></Link>
        <Link to="/tenzies-game"><img src={tenziesGameImg} alt="Tenzies Game section cover"/></Link>
      </div>
    </section>
  );
}
